...
<head>
    ...
    <title>รายการยืมที่คืนแล้ว</title>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                          <div class="table-responsive">
                              ...
                              if($_GET["txtKeyword"] != "");
                              $select = "SELECT * FROM borrow_detail NATURAL JOIN borrow NATURAL JOIN member NATURAL JOIN category NATURAL JOIN durable WHERE bd_status =3
