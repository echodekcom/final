     ...
     ?>
      <tbody>
         <tr class="odd gradeX">
              ...
              <td>
              <button class="btn btn-default" type="button" onclick="window.location.href='admin_update_cart1.php?itemId1=<?php echo $result["id"]; ?>'"> <i class="fa fa-plus"> แจ้งซ่อม</i></button>
              </td>
          </tr>
     </tbody>
    <?php
