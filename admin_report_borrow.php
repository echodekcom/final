                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                          <div class="table-responsive">
                              ...
                              if ($Num_Rows==0) {
                                  echo "ขณะนี้ยังไม่มีรายงานครุภัณฑ์ที่ยืม";
                              }else{
                              ?>
                              <form class="form-inline" name="frmSearch" method="get" action="<?php echo $_SERVER['SCRIPT_NAME'];?>">
                                <div class="text-center">
                                    ...
                                    <div class="form-group">
                                        <a href="print/print_borrow.php?strKeyword=<?php echo $_GET["txtKeyword"]; ?>" class="btn btn-default" style="background-color: #00b3b3;color: #fff;"><i class="fa fa-print"></i> พิมพ์ข้อมูล</a>
                                    </div>
                                </div><br>
