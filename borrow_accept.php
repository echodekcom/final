...
<head>
    ...
    <title>รายการยืมที่อนุมัติ</title>
    ...
    ?>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2>รายการยืมที่ผ่านการอนุมัติ</h2>
                    </div>
                </div>
                 <!-- /. ROW  -->
                 <hr />
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                          <div class="table-responsive">
                              ...
                              if($_GET["txtKeyword"] != "");
                              $select = "SELECT * FROM borrow_detail NATURAL JOIN borrow NATURAL JOIN member NATURAL JOIN category NATURAL JOIN durable WHERE bd_status =1
                              ...
                              <table class="table table-striped table-bordered table-hover">
                                  <thead>
                                      <tr>
                                          ...
                                          <th class="text-center">คืนครุภัณฑ์</th>
                                      </tr>
                                  </thead>
                                  ...
                                  <tbody>
                                      <tr class="odd gradeX">
                                          ...
                                          <td class="text-center"><a href="admin_update_borrow.php?submit=del&action=return&bd_id=<?php echo $result["bd_id"];?>&b_id=<?php echo $result["b_id"];?>&id=<?php echo $result["id"];?>" class="btn btn-danger" onclick="return checkreturn();"><i class="fa fa-reply"></i></a></td>
                                      </tr>
                                  </tbody>
                                  <?php } ?>
                              </table><hr>
